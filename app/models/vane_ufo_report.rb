...
# zgrep --no-filename 40303 receive.log.2016-11-* >> /home/deployer/sun_vanke_log/vanke_ufo_report.log.2016-11-30
class VaneUFOReport
  # usage:VaneUFOReport.execute('2016-11-01', '2016-11-30', 40303)
  # 得到每次开灯时长
