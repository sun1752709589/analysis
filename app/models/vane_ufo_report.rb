...
# zgrep --no-filename 40303 receive.log.2016-10-* >> /home/deployer/sun_vanke_log/vanke_ufo_report.log.2016-10-31
class VaneUFOReport
  # usage:VaneUFOReport.execute('2016-10-01', '2016-10-31', 40303)
  # 得到每次开灯时长
  def self.get_by_hash(start_time, end_time, device_ip)
    ...
    data.each do |item|
      ...
      next if off.nil?
      if (off.created_at.to_i - item.created_at.to_i) < 1000000000
