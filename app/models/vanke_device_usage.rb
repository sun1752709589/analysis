...
# 内网 scp -p 12221 deployer@10.132.7.167:/home/deployer/nginx_access_log/vanke_heater.log.2016-04-30 /home/deployer/sun_vanke_log/
  # app控制和墙面开关控制热水器
  ...
  # zgrep --no-filename switch_o access.log.[2-5].gz >> /home/deployer/nginx_access_log/vanke_heater.log.2016-04-30
  # grep --no-filename switch_o access.log access.log.1 >> /home/deployer/nginx_access_log/vanke_heater.log.2016-04-30
  # VankeDeviceUsage.fetch_heater_data('2016-04-01', '2016-04-30')
  ...
  # zgrep --no-filename vanke_eco_towers access.log.[2-5].gz >> /home/deployer/nginx_access_log/vanke_ecotower.log.2016-04-30
  # zgrep --no-filename vanke_eco_towers access.log access.log.1 >> /home/deployer/nginx_access_log/vanke_ecotower.log.2016-04-30
  # VankeDeviceUsage.fetch_ecotower_data('2016-04-01', '2016-04-30')
  ...
  # zgrep --no-filename door_accesses access.log.[2-5].gz >> /home/deployer/nginx_access_log/vanke_dooraccesses.log.2016-04-30
  # zgrep --no-filename door_accesses access.log access.log.1 >> /home/deployer/nginx_access_log/vanke_dooraccesses.log.2016-04-30
  # VankeDeviceUsage.fetch_dooraccesses_data('2016-04-01', '2016-04-30')
