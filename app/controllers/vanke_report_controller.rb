class VankeReportController < ApplicationController
  def index
    ...
    @heater_usage_by_hour = VankeDeviceUsage.device_usage_by_hour('heater','2015-11-08','2015-12-12')
    @ecotower_usage_by_hour = VankeDeviceUsage.device_usage_by_hour('ecotower','2015-11-08','2015-12-12')
  end
end
